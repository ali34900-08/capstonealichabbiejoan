        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Downloaded</a>
                        <a class="collapse-item" href="">Uploaded</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Register Collapse Menu -->
              <li class="nav-item">
                ...
                <div id="collapseRegister" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Register a:</h6>
                        <a class="collapse-item" href="student_register.php">Student</a>
