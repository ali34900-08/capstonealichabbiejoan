              ...
              <?php
              $query = mysqli_query($link,"select * from users where id = '$get_id'")or die(mysqli_error());
...
mysqli_query($link,"UPDATE users SET username='$username', password='$password', firstname='$firstname', lastname='$lastname' where id = '$get_id' ")or die(mysqli_error());
?>
